...
#include "pshglob.h"
                         ...
                         PSH_Blue_Table  bot_table )
  {
    ...
    for ( ; read_count > 0; read_count -= 2 )
    {
      ...
      for ( ; count > 0; count--, zone++ )
      {
        ...
        if ( reference == zone->org_ref )
        {
          FT2_1_3_Int  delta0 = zone->org_delta;
                         ...
                         FT2_1_3_Pos     delta )
  {
    ...
    /*                                                        */
    {
      FT2_1_3_Int  threshold = blues->blue_shift;
